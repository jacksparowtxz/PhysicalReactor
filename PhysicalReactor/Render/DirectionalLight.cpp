...
DirectionalLight::DirectionalLight():color({ 1.0f,1.0f,1.0f,1.0f }), Direction({ 0.0f,0.0f,0.0f }), Intensity(0.f)/*:lightsourceangle(0.0f),occlusionmaskdrakness(0.0f),occlusiondepthrange(0.0f),DistanceFieldShadowDistance(0.0f),
